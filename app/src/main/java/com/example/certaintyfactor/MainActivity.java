package com.example.certaintyfactor;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnProses;
    TextView tvOutput;
    CheckBox chkGejala1, chkGejala2, chkGejala3, chkGejala4, chkGejala5, chkGejala6, chkGejala7, chkGejala8, chkGejala9, chkGejala10, chkGejala11, chkGejala12, chkGejala13, chkGejala14, chkGejala15, chkGejala16,
            chkGejala17, chkGejala18, chkGejala19, chkGejala20, chkGejala21, chkGejala22, chkGejala23, chkGejala24, chkGejala25;
    AutoCompleteTextView txtNilaiGejala1, txtNilaiGejala2, txtNilaiGejala3, txtNilaiGejala4, txtNilaiGejala5, txtNilaiGejala6, txtNilaiGejala7, txtNilaiGejala8, txtNilaiGejala9,
            txtNilaiGejala10, txtNilaiGejala11, txtNilaiGejala12, txtNilaiGejala13, txtNilaiGejala14, txtNilaiGejala15, txtNilaiGejala16, txtNilaiGejala17, txtNilaiGejala18, txtNilaiGejala19,
            txtNilaiGejala20, txtNilaiGejala21, txtNilaiGejala22, txtNilaiGejala23, txtNilaiGejala24, txtNilaiGejala25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNilaiGejala6 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView7);
        txtNilaiGejala7 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView8);
        txtNilaiGejala8 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView9);
        txtNilaiGejala9 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView10);
        txtNilaiGejala10 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView11);
        txtNilaiGejala11 = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView6);
        ...
        txtNilaiGejala1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new AlertDialog.Builder(MainActivity.this).setTitle("Pilih Nilai Gejala").
        ...
        btnProses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chkGejala6.isChecked() && chkGejala7.isChecked() && chkGejala8.isChecked() && chkGejala9.isChecked()){

                    // NILAI DARI PAKAR / AHLI
                    double nilaiGejala6 = 0.4;
                    double nilaiGejala7 = 0.4;
                    ...
                    double Combine_CF1_CF2 = hasilHitunganGejala6 + hasilHitunganGejala7 * (1 - hasilHitunganGejala6);
                    double Combine_CFold_CF3 = Combine_CF1_CF2 + hasilHitunganGejala8 * (1 - Combine_CF1_CF2);
                    double Combine_CFold_CF4 = Combine_CFold_CF3 + hasilHitunganGejala9 * (1 - Combine_CFold_CF3);


                    String hasilHitungGejalaPenyakitB = String.valueOf((Combine_CFold_CF4 * 100));

                    NamaPenyakit += "\nTinea cruris"+"\n"+hasilHitungGejalaPenyakitB+" %";

                }

                if (chkGejala10.isChecked() && chkGejala11.isChecked() && chkGejala12.isChecked()){

                    // NILAI DARI PAKAR / AHLI
                    double nilaiGejala10 = 0.4;
                    ...
                    double Combine_CF1_CF2 = hasilHitunganGejala10 + hasilHitunganGejala11 * (1 - hasilHitunganGejala10);
                    double Combine_CFold_CF3 = Combine_CF1_CF2 + hasilHitunganGejala12 * (1 - Combine_CF1_CF2);


                    String hasilHitungGejalaPenyakitC = String.valueOf((Combine_CFold_CF3 * 100));
                ...
                if (chkGejala13.isChecked() && chkGejala14.isChecked() && chkGejala15.isChecked() && chkGejala16.isChecked() && chkGejala17.isChecked() && chkGejala18.isChecked()){
                    ...
                    double Combine_CF1_CF2 = hasilHitunganGejala13 + hasilHitunganGejala14 * (1 - hasilHitunganGejala13);
                    double Combine_CFold_CF3 = Combine_CF1_CF2 + hasilHitunganGejala15 * (1 - Combine_CF1_CF2);
                    double Combine_CFold_CF4 = Combine_CFold_CF3 + hasilHitunganGejala16 * (1 - Combine_CFold_CF3);
                    double Combine_CFold_CF5 = Combine_CFold_CF4 + hasilHitunganGejala17 * (1 - Combine_CFold_CF4);
                    double Combine_CFold_CF6 = Combine_CFold_CF5 + hasilHitunganGejala18 * (1 - Combine_CFold_CF5);


                    String hasilHitungGejalaPenyakitD = String.valueOf((Combine_CFold_CF6 * 100));
                ...
                if (chkGejala19.isChecked() && chkGejala20.isChecked() && chkGejala21.isChecked()){

                    // NILAI DARI PAKAR / AHLI
                    double nilaiGejala19 = 0.6;
                    double nilaiGejala20 = 0.2;
                    double nilaiGejala21 = 0.8;
                    ...
                    double Combine_CF1_CF2 = hasilHitunganGejala19 + hasilHitunganGejala20 * (1 - hasilHitunganGejala19);
                    double Combine_CFold_CF3 = Combine_CF1_CF2 + hasilHitunganGejala21 * (1 - Combine_CF1_CF2);


                    String hasilHitungGejalaPenyakitE = String.valueOf((Combine_CFold_CF3 * 100));
                ...
                if (chkGejala22.isChecked() && chkGejala23.isChecked() && chkGejala24.isChecked() && chkGejala25.isChecked()){

                    // NILAI DARI PAKAR / AHLI
                    double nilaiGejala22 = 0.8;
                    double nilaiGejala23 = 0.6;
                    double nilaiGejala24 = 0.6;
                    ...
                    double hasilHitunganGejala22 = nilaiGejala22 * doubleGejala22;
                    ...
                    double Combine_CF1_CF2 = hasilHitunganGejala22 + hasilHitunganGejala23 * (1 - hasilHitunganGejala22);
                    double Combine_CFold_CF3 = Combine_CF1_CF2 + hasilHitunganGejala24 * (1 - Combine_CF1_CF2);
                    double Combine_CFold_CF4 = Combine_CFold_CF3 + hasilHitunganGejala25 * (1 - Combine_CFold_CF3);


                    String hasilHitungGejalaPenyakitF = String.valueOf((Combine_CFold_CF4 * 100));
